...
cd /var/www/$URL/html
git clone https://github.com/icodefortacos/bstrap.git
cd /
...
server {
        ...
        root /var/www/$URL/html/bstrap/;
        index index.html;

        server_name $URL;
        access_log /var/log/nginx/$URL-443.access.log;
        error_log /var/log/nginx/$URL-443.error.log;
...
server {
 ...
 #   } # managed by Certbot
        ...
        server_name $URL;
        access_log /var/log/nginx/$URL-80.access.log;
        error_log /var/log/nginx/$URL-80.error.log;
